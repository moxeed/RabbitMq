...
namespace RabbitMqAck.Test
{
    public class ManualAckTest
    {
        ...
        public async Task MultipleDetectorsManualAck_SendMessage_PerfomanceEvaludated(int detectorCount, ushort prefetchCount, int messageCount)
        {
            var queueName = nameof(MultipleDetectorsManualAck_SendMessage_PerfomanceEvaludated);
